...
@ObjCClassName("PaxBritannicaIOS")
public class PaxBritannicaIOS extends NSObject implements UIApplicationDelegate {
	...
	public boolean applicationDidFinishLaunchingWithOptions(
		...
		this.app = new IOSApplication(new PaxBritannica(), config);
	...
	public static void main(String[] args) {
		UIKit.UIApplicationMain(0, null, null,
				PaxBritannicaIOS.class.getSimpleName());
	}
	...
	@Generated("NatJ")
	@Selector("alloc")
	public static native PaxBritannicaIOS alloc();

	@Generated("NatJ")
	protected PaxBritannicaIOS(Pointer peer) {
		super(peer);
	}
	
	@Selector("init")
	public PaxBritannicaIOS init() {
		super.init();
		return this;
	}
